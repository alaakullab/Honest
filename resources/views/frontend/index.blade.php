...
@section('content')
    ...
    <section class="section grey lighten-4 center">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">{{__('app.Services')}}</h4>
            </div>
            <div class="row">
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">{{__('app.Featured Items')}}</h4>
            </div>
            <div class="row">
    ...
    <section class="section grey lighten-3 center">
        <div class="container">
            ...
            <h4 class="section-heading">{{__('app.Testimonials')}}</h4>
    ...
    <section class="section center">
        <div class="row">
            <h4 class="section-heading">{{__('app.Recent Blog')}}</h4>
        </div>
        <div class="container">
            <div class="row">
