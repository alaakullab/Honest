<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">{{__('app.Popular Posts')}}</h3>
        <ul class="collection">
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">{{__('app.Categories')}}</h3>
        <ul>
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">{{__('app.Archives')}}</h3>
        <ul class="collection">
